package ma.cigma.security.config;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (!StringUtils.isEmpty(userEmail) && SecurityContextHolder.getContext().getAuthentication()==null){
            ...
            // Check and handle requesterId
            final String requesterId = request.getHeader("requesterId");
            if (StringUtils.isEmpty(requesterId) || !isValidEmail(requesterId) || !requesterId.equalsIgnoreCase(userEmail)) {
